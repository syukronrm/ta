...
//    }
    ...
    naiveApproach.addNodes(cal_table_nodes.toSet)
    naiveApproach.addRawEdges(cal_table_edges.toSet)
...
//    val naiveApproach = new Naive
//    naiveApproach.addNodes(cal_table_nodes)
//    naiveApproach.addRawEdges(cal_table_edges)

    val streams_ = Dataset.generateObjects()

    streams_.foldLeft(streams_) {(acc, stream) => {
